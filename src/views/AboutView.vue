  ...
  <div class="sub-container" style="padding: 2.5rem">
    <div class="flex" style="position: relative">
      <div style="width: 50%" class="left-hero">
        ...
        <h1 class="hero">
          Where Banking Meets <span class="green-text">Excellence!</span>
        </h1>
      ...
      <div class="right-hero">
        <img style="" src="/images/about-hero.png" alt="" />
      </div>
    </div>
  </div>
</main>
...
<main style="margin-top: 16rem">
  <h1 class="green-text semi-big top-margin">Mission & Vision</h1>
  ...
  >
    ...
    >
      <div class="">
        <h1 style="font-size: 2.3rem; align-self: stretch">Mission</h1>
        <p class="light-text" style="align-self: stretch">
  ...
  <div style="display: none" class="grid grid-cols-2 top-margin">
    <div class="mission-image-container">
      <img style="" src="/images/about1.png" alt="" />
    </div>

    <div class="flex items-center">
      <div class="mission-text-container">
        <h1 style="font: 2rem">Mission</h1>
        <p class="light-text">
          At YourBank, our mission is to empower our customers to achieve
          financial success. We are dedicated to delivering innovative banking
          solutions that cater to their unique needs. Through personalized
  ...
  <div
    ...
    "
  >
    <div class="figma-text-container">
      <div class="">
        <h1 style="font-size: 2rem; align-self: stretch">Vision</h1>
        <p class="light-text" style="align-self: stretch">
          At YourBank, our mission is to empower our customers to achieve
          financial success. We are dedicated to delivering innovative banking
          solutions that cater to their unique needs. Through personalized
...
<main>
  <h1 class="green-text semi-big">Press Releases</h1>
  ...
  <div class="grid grid-cols-2 gap-4 top-margin">
    <div class="press-card">
      ...
      <p class="light-text">
        ...
        banking experience. The program offers exclusive benefits, discounts,
        and personalized offers tailored to individual customer preferences.
        With this initiative, YourBank reaffirms its commitment to delivering
        exceptional value and building lasting relationships with our valued
        customers.
      </p>
    </div>
    ...
    <div class="press-card">
      ...
      <p class="light-text">
        ...
        in [City]. This expansion is a testament to our continued commitment
        to serving our customers and providing them with convenient access to
        our comprehensive range of banking services. The new branch will
        feature state-of-the-art facilities, a team of dedicated
        professionals, and a personalized approach to banking, further
...
.figma-image-container {
  ...
  /* background: radial-gradient(61.15% 55.12% at 44.88% 50%, rgba(202, 255, 51, 0.30) 19.48%, rgba(25, 25, 25, 0.30) 100%); */
  background: linear-gradient(
    ...
    radial-gradient(
      61.15% 55.12% at 44.88% 50%,
      rgba(202, 255, 51, 0.3) 19.48%,
      rgba(25, 25, 25, 0.3) 100%
    );
  background-blend-mode: normal, normal, screen;
}

.figma-text-container {
  display: flex;
...
.img-container-1 {
  ...
  background: url("/images/press1.png"), lightgray 50% / cover no-repeat;
}

.img-container-2 {
  height: 300px;
  border-radius: 1.875rem 1.875rem 0.75rem 0.75rem;
  background: url("/images/press2.png"), lightgray 50% / cover no-repeat;
}

.img-container-3 {
  height: 300px;
  border-radius: 1.875rem 1.875rem 0.75rem 0.75rem;
  background: url("/images/press3.png"), lightgray 50% / cover no-repeat;
}

.img-container-4 {
  height: 300px;
  border-radius: 1.875rem 1.875rem 0.75rem 0.75rem;
  background: url("/images/press4.png"), lightgray 50% / cover no-repeat;
}
